...
\begin{enumerate}
    ...
    \end{multline*}
    Обозначим $f_{x1} - f_{x3} = g_{x1}$, $f_{x2} - f_{x3} = g_{x2}$, $f_{y1} - f_{y3} = g_{y1}$, $f_{y2} - f_{y3} = g_{y2}$.  
    \begin{multline*}
      \frac{\partial f_x}{\partial x} \frac{\partial f_y}{\partial y} - \frac{\partial f_x}{\partial y} \frac{\partial f_y}{\partial x} 
      = \frac{1}{\Delta^2} \\ ( \left[ (x_1 - x_3)(y_2 - y_3) g_{x1} g_{y2} + (x_2 - x_3)(y_1 - y_3) g_{x2} g_{y1} -
      (x_1 - x_3)(y_1 - y_3) g_{x1} g_{y1} - (x_2 - x_3) (y_2 - y_3) g_{x2} g_{y2} \right] - \\
      - \left[ (x_1 - x_3)(y_2 - y_3) g_{x2} g_{y1} + (x_2 - x_3)(y_2 - y_3) g_{x1} g_{y2} - 
      (x_1 - x_3)(y_1 - y_3) g_{x2} g_{y2} - (x_2 - x_3) (y_2 - y_3) g_{x1} g_{y1} \right] ) = \\
      = \frac{1}{\Delta^2} (\Delta g_{x1} g_{y2} - \Delta g_{x2} g_{y1} - \left[(x_1 - x_3) (y_1 - y_3) - (x_2 - x_3)(y_2 - y_3)\right] (g_{x1} g_{y1} - g_{x2} g_{y2}) ) = \\
      = \frac{1}{\Delta} (
    \end{multline*}
